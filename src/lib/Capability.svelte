<script lang="ts">
	...
	import CapabilityGraph from "./CapabilityGraph.svelte";
...
<div
	class="m-4 w-min space-y-1 flex flex-col items-center border border-gray-300 rounded-md shadow-lg p-2"
>
	<div class="flex flex-row space-x-1 w-min">
